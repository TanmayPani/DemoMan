...
class wxMovieShape(wxShape):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(parent, orient=orient, title=title)
        self.movieCtrl = MediaCtrl(self.StaticBox,szBackend=wx.media.MEDIABACKEND_WMP10, style=style, **kwargs)
    ...
    def LoadVideo(self, file_name, thumbnail_file_name=None):
        ...
        # self.movieCtrl.Load(self.fileName)
